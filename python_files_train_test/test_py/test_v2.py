...
from bert_tester_v2 import Bert, test_v2
...
print('Test is based on v2.0 test')
...
for directory in dirs:
   ...
   print()
   print('Testing Model')
   em, f1, recall = test_v2(bert_model, collection, docs)
   ...
   print('#################################################################')
   print()
   f1_scores.append(f1_score_calc)   

sorted_index = np.argsort(f1_scores)[::-1]
